...
variable "dapr_application_insights_connection_string" {
  description = "(Required) Specifies an Application Insights connection string used by Dapr to export Service to Service communication telemetry. Changing this forces a new resource to be created."
  type        = string
  nullable    = false
}
